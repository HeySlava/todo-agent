...
Если ты не можешь определить тип задачи, верни JSON с task = 'unknown', а в payload, для ключа summary напиши какой информации тебе не хватило для корректной классификации. Эта информация далее пойдет на вход функции, которая умеет работать с json, поэтому не додавляй никакого форматирования. # noqa: E501
